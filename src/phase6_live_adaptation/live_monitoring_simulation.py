...
# Countries and their selected SARIMA orders
COUNTRIES = ['AT', 'BE', 'BG']

# Selected models from Phase 3
SELECTED_MODELS = {
    'AT': {'order': (2, 0, 2), 'seasonal_order': (1, 1, 1, 24)},
    'BE': {'order': (2, 0, 2), 'seasonal_order': (1, 1, 1, 24)},
    'BG': {'order': (1, 0, 2), 'seasonal_order': (1, 1, 1, 24)}
}
