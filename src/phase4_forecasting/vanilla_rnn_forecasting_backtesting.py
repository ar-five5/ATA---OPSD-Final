...
os.makedirs(os.path.join(base_dir, 'results/phase4d_rnn_results'), exist_ok=True)

print("="*80)
print("PHASE 4d: VANILLA RNN FORECASTING AND BACKTESTING")
print("="*80)
...
class VanillaRNNForecaster(nn.Module):
    """Vanilla RNN model for multi-step time series forecasting"""
...
# LOAD TRAINED MODELS
print("\n[2/6] Loading trained Vanilla RNN models...")
...
for idx, country in enumerate(countries):
    ...
    df_plot = pd.read_csv(os.path.join(base_dir, f'results/phase4d_rnn_results/forecast_data_{country}.csv'), parse_dates=['timestamp'])
...
# SUMMARY
print("\n" + "="*80)
print("PHASE 4d SUMMARY: VANILLA RNN FORECASTING RESULTS")
print("="*80)
print("\nPerformance Metrics:")
